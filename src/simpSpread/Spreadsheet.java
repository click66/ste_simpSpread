...
public class Spreadsheet
{
    ...
    private final simpSpread.WorkBook workBook;
    private boolean prettyPrint = false;

    public Spreadsheet(simpSpread.WorkBook workBook)
    {
        this.workBook = workBook;
    }

    public Spreadsheet(simpSpread.WorkBook workBook, boolean prettyPrint)
    {
        this.workBook = workBook;
